...
export default function Board(props: Props) {
  ...
  return <div className="gc-board-wrap">
    ...
    <div className="gc-board-foot"><span>{flat || failed ? 'Select a piece, then its destination.' : 'Tap to move · Drag to orbit · Pinch to zoom'}</span><span>{props.player === 'w' ? 'WHITE' : 'BLACK'} AT HOME</span></div>
  </div>;
}
